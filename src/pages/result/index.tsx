...
function useResultPage() {
    ...
    return {selectedDate, zusDay, handleDateChange, masterName, daysMaster}
}
            ...
            <fieldset className="relative mx-3.25 mt-3.25 grid grid-cols-2 gap-x-3.5 z-30">
                <div className="h-fit flex flex-col">
                    ...
                    <DatePicker
                        ...
                        customInput={<div className="w-full h-fit mt-3.25 py-17.5 px-28 bg-white border-1 border-light_grey2 rounded-20">{zusDay == "" ? "00.00.0000" : zusDay}</div>}
                        popperClassName="transform translate-x-10"
                        popperPlacement="bottom-start"
                        showIcon
                        icon={
                            <svg className="absolute z-50 top-28 right-4.5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
