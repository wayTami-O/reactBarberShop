    ...
    <>
        ...
        <div className="w-full px-3.25 pt-3.25">
            <div className="w-full px-3 pb-5 25 pt-3.25 grid grid-cols-2 gap-x-3 gap-y-3.25">
                <div className="w-148 h-300 bg-white border-1 border-light_grey2 rounded-55 overflow-hidden shadow-button">
                    ...
                    <div className="w-full px-3.25 pt-3.25 flex justify-between">
                        ...
                        <div className={`w-4.5 h-4.5 border-1 border-dark rounded-100 flex justify-center items-center ${master == '0' ? 'bg-dark' : ''}`} onClick={(): void => {handleMaster('0')}}>
