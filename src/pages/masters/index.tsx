    ...
    <>
        ...
        <div className="w-full px-3.25 pt-3.25">
            <div className="w-full px-3 pb-5 25 pt-3.25 grid grid-cols-2 gap-x-3 gap-y-3.25">
                <div className="w-148 h-300 bg-white border-1 border-light_grey2 rounded-55 overflow-hidden shadow-button relative z-10" onClick={(): void => {handleMaster('0', "Любой мастер")}}>
